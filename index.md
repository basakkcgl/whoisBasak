...
I am interested in fundamental problems in explainable AI. Once we have some explanation on **why** neural networks do they do what they do (which requires questioning causation A LOT), I want to create machines that are more efficient and robust in learning. I try to achieve that by *"translating"* what we know from neuroscience into machines. And sometimes I go the other way around, and play around with machine learning methods to get some insights on brains.
